...
def test(n=None,
    ...
    gaussian_blur(np.zeros((100,100)), np.zeros((100,100)))
...
#    ans1 = util.test_image_pipeline_filename(gaussian_blur, (input_img_rgb,), n, name='blur_one_stage.gaussian_blur rgb', use_output_img=True)
    ans2 = util.test_image_pipeline_filename(gaussian_blur, (input_img_gray,), n, grayscale=True, name='blur_one_stage.gaussian_blur gray', use_output_img=True)
    return util.combine_tests((ans2,))
